"""
Front Seven Index's own real calculation chain -- tenth fully-wired tab. Team-level (32 real
teams), standard shape, 3 real metrics (Sack Rate, TFL Rate, QB Hit Rate), all higher-is-
better, no inversion. Same shared functions as Secondary Index/OL Index, unchanged.
"""
...
@dataclass
class FrontSevenIndexConstants:
    decay_factor: float
...
def compute_front_seven_index(
    history: FrontSevenTeamHistory, constants: FrontSevenIndexConstants,

...
player-level positions may need real historical snap-count or depth-chart data
(`fetch_depth_charts()`) rather than a volume-ranking proxy, since e.g. WR/CB rotations don't
rank as cleanly by a single stat.
